  ...
  const socialRow = enabledSocials.map((s, i) => `
    <td class="pc-g-rpt pc-g-rpb pc-w800-itemsVSpacings-0" valign="middle" style="padding-top: 0px; padding-bottom: 0px;">
      <table border="0" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td align="left" valign="middle"> <a class="pc-font-alt" href="${s.url}" target="_blank" style="text-decoration: none; display: inline-block; vertical-align: top;"> <img src="${s.icon}" class="" width="18" height="18" style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 18px; height: 18px;" alt="" /> </a> </td>
        </tr>
      </table>
    </td>
